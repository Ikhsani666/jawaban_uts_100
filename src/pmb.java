...
public class pmb {
    ...
    public static void PrintInfoMahasiswaBaru() {
        ...
        for (int i = 0; i < Informatika.length; i++) {
            if (Informatika[i] != null) {
                jumlahInformatika++;
            }
        }
        int jumlahDkv = 0;
        for (int a = 0; a < Dkv.length; a++) {
            if (Dkv[a] != null) {
                jumlahDkv++;
            }
        }
    ...
    public static void inputMahasiswabaru() {
        ...
        while (true) {
            ...
            String jenisprodi = inputData.nextLine();
            if (namaMahasiswabaru.isBlank()) {
                System.out.println("mahasiswa baru wajib diisi ");
                inputMahasiswabaru();
            }
            if (jenisprodi.isBlank()) {
                System.out.println("mahasiswa baru wajib diisi ");
                inputMahasiswabaru();
            }
            else {
                ...
                simpanMahasiswa(JenisRandom, jenisprodi);
